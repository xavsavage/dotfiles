...
alias interwebs='chromium --user-data-dir=/home/xavier/.config/chromium/'
alias light='sudo tee /sys/class/backlight/acpi_video0/brightness <<<'
alias screenfetch='screenfetch -c 4,'
alias lock='/home/xavier/.scripts/lockscreen/lockscreen.sh'
alias nano='vim'
alias :q='exit'
